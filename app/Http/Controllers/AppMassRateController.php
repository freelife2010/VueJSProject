...
class AppMassRateController extends AppBaseController
{
    use BillingTrait;
    ...
    {
        $APP      = $this->app;
        $title    = $APP->name . ': Mass rates';
        $subtitle = 'Manage mass rates';

        return view('appMassRates.index', compact('title', 'subtitle', 'APP'));
    }
